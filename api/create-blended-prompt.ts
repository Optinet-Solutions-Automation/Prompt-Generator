...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    //   brand: "SpinJo",
    //   selectedReferences: [
    //     { recordId: "rec123", name: "Stormcraft Arrival" },
    //     { recordId: "rec456", name: "Neon Astronaut" }
    //   ]
    // }
    // n8n fetches each record's positive_prompt from Airtable,
    // then uses GPT to blend them into a new unique prompt.
