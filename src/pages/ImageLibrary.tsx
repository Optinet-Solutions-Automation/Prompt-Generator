                ...
                {showVariationsPanel && (
                  <div className="space-y-2.5">
                    ...
                    {selectedEngine === 'compare' ? (
                      ...
                      <p className="text-white/30 text-[10px] italic">Generates 4 variations — each with a different level of change</p>
                    )}
                    ...
                    >
                      {isGeneratingVariations ? (
                        ...
                        <><Shuffle className="w-3.5 h-3.5" />{generatedVariations.length > 0 ? 'Regenerate Variations' : (selectedEngine === 'compare' ? 'Generate Both (4 total)' : 'Generate 4 Variations')}</>
                      )}
                    </button>
                  </div>
                )}
